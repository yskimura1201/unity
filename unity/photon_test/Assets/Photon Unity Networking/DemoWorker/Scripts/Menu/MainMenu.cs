...
public class MainMenu : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label("Player name:", GUILayout.Width(100),GUILayout.Height(80));
        PhotonNetwork.playerName = GUILayout.TextField(PhotonNetwork.playerName,GUILayout.Height(80));
        GUILayout.Space(105);
        if (GUI.changed)
        {
            // Save name
        ...
        // Join room by title
        GUILayout.BeginHorizontal();
        GUILayout.Label("Roomname:", GUILayout.Width(100),GUILayout.Height(80));
        this.roomName = GUILayout.TextField(this.roomName,GUILayout.Height(80));
        
        if (GUILayout.Button("Create Room", GUILayout.Width(100),GUILayout.Height(80)))
        {
        ...
        if (GUILayout.Button("Join Room", GUILayout.Width(100),GUILayout.Height(80)))
        {
